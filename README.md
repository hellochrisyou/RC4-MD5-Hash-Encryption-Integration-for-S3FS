...
3. Integrate stand-alone algorithm (RC4 + MD5 Hash) into S3FS code-base (which would <b><u>enable encrypting/decrypting any files that is modified in a mounted bucket</u></b>)
